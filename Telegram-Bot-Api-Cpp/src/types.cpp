...
void TelegramTypes::API::sendMessage(const std::string& chat_id,
...
void TelegramTypes::API::sendDocument(const std::string& chat_id,
...
void TelegramTypes::API::sendPhoto(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::sendAudio(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::sendAnimation(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::sendVoice(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::sendVideoNote(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::sendVideo(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::sendMediaGroup(const std::string& chat_id,
	const std::string& mime_type,
...
void TelegramTypes::API::copyMessage(const Json::Value& from_chat_id,
...
void TelegramTypes::API::sendLocation(const float& latitude,
...
void TelegramTypes::API::editMessageLiveLocation(const float& latitude,
	const float& longitude,
	const Json::Value& reply_markup,
...
void TelegramTypes::API::stopMessageLiveLocation(const std::string& chat_id,
	const __int64& message_id,
	const std::string& inline_message_id,
	const Json::Value& reply_markup) const {
	std::string text;
...
void TelegramTypes::API::sendVenue(const float& latitude,
	const float& longitude,
	const std::string& title,
...
void TelegramTypes::API::sendContact(const std::string& phone_number,
...
void TelegramTypes::API::sendPoll(const std::string& question,
...
void TelegramTypes::API::sendDice(const std::string& chat_id,
...
void TelegramTypes::API::sendChatAction(const std::string& chat_id,
...
Json::Value TelegramTypes::API::getUserProfilePhotos(const __int64& user_id,
...
Json::Value TelegramTypes::API::getFile(const std::string& file_id) {
	std::string text;
	text = "";
...
void TelegramTypes::API::kickChatMember(const __int64& user_id,
	const std::string& chat_id,
...
void TelegramTypes::API::unbanChatMember(const __int64& user_id,
	const std::string& chat_id,
...
void TelegramTypes::API::restrictChatMember(const __int64& user_id,
...
void TelegramTypes::API::promoteChatMember(const __int64& user_id,
	const std::string& chat_id,
...
void TelegramTypes::API::setChatAdministratorCustomTitle(const __int64& user_id,
...
void TelegramTypes::API::setChatPermissions(const Json::Value& permissions,
	const std::string& chat_id) const {
	std::string text;
	text = "";
	std::string result;
...
void TelegramTypes::API::exportChatInviteLink(const std::string& chat_id) const {
	std::string text;
	text = "";
	std::string result;
	Json::StreamWriterBuilder wbuilder;
...
void TelegramTypes::API::setChatPhoto(const Json::Value& photo,
	const std::string& chat_id) const {
	std::string text;
	text = "";
	std::string result;
...
void TelegramTypes::API::deleteChatPhoto(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + chat_id + "&";
...
void TelegramTypes::API::setChatTitle(const std::string& title,
	const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "title=" + title + "&";
...
void TelegramTypes::API::setChatDescription(const std::string& chat_id,
...
void TelegramTypes::API::pinChatMessage(const __int64& message_id,
	const std::string& chat_id,
...
void TelegramTypes::API::unpinChatMessage(const std::string& chat_id,
...
void TelegramTypes::API::unpinAllChatMessages(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + chat_id + "&";
...
void TelegramTypes::API::leaveChat(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + chat_id + "&";
...
Json::Value TelegramTypes::API::getChat(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + "" + chat_id + "&";
...
Json::Value TelegramTypes::API::getChatAdministrators(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + chat_id + "&";
...
Json::Value TelegramTypes::API::getChatMembersCount(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + chat_id + "&";
...
Json::Value TelegramTypes::API::getChatMember(const __int64& user_id,
	const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "user_id=" + std::to_string(user_id) + "&";
...
void TelegramTypes::API::setChatStickerSet(const std::string& sticker_set_name,
	const std::string& chat_id) const {
	std::string text;
	text = "";
...
void TelegramTypes::API::deleteChatStickerSet(const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "chat_id=" + chat_id + "&";
...
void TelegramTypes::API::answerCallbackQuery(const std::string& callback_query_id,
...
void TelegramTypes::API::setMyCommands(const Json::Value& commands) {
	std::string text;
	text = "";
	std::string result;
	Json::StreamWriterBuilder wbuilder;
...
Json::Value TelegramTypes::API::getMyCommands(const std::string& text,
	const std::string& chat_id,
	const __int64& message_id,
	const std::string& inline_message_id,
	const std::string& parse_mode,
...
void TelegramTypes::API::editMessageCaption(const std::string& chat_id,
	const __int64& message_id,
	const std::string& inline_message_id,
	const std::string& caption,
	const std::string& parse_mode,
...
void TelegramTypes::API::editMessageMedia(const Json::Value& media,
	const std::string& chat_id,
	const __int64& message_id,
	const std::string& inline_message_id,
	const Json::Value& reply_markup) const {
...
void TelegramTypes::API::editMessageReplyMarkup(const std::string& chat_id,
	const __int64& message_id,
	const std::string& inline_message_id,
	const Json::Value& reply_markup) const {
	std::string text;
...
void TelegramTypes::API::stopPoll(const __int64& message_id,
	const std::string& chat_id,
	const Json::Value& reply_markup) const {
	std::string text;
	text = "";
...
void TelegramTypes::API::deleteMessage(const __int64& message_id,
	const std::string& chat_id) const {
	std::string text;
	text = "";
	text = text + "message_id=" + std::to_string(message_id) + "&";
...
void TelegramTypes::API::sendSticker(const Json::Value& sticker,
	const std::string& chat_id,
	const bool& disable_notification,
	const __int64& reply_to_message_id,
	const bool& allow_sending_without_reply,
...
Json::Value TelegramTypes::API::getStickerSet(const std::string& name) {
	std::string text;
	text = "";
	text = text + "name=" + name + "&";
...
void TelegramTypes::API::uploadStickerFile(const Json::Value& png_sticker,
...
void TelegramTypes::API::createNewStickerSet(const std::string& emojis,
	const std::string& title,
	const __int64& user_id,
...
void TelegramTypes::API::addStickerToSet(const std::string& name,
...
void TelegramTypes::API::setStickerPositionInSet(const __int64& position,
...
void TelegramTypes::API::deleteStickerFromSet(const std::string& sticker) {
	std::string text;
	text = "";
	text = text + "sticker=" + sticker + "&";
...
void TelegramTypes::API::setStickerSetThumb(const __int64& user_id,
	const std::string& name,
...
void TelegramTypes::API::sendQuery(std::string& query) const {
	CURL* curl;
	CURLcode res;
	std::string readBuffer;
	curl = curl_easy_init();
...
Json::Value TelegramTypes::API::getQuery(std::string& query) const {
	CURL* curl;
	CURLcode res;
	std::string readBuffer;
	curl = curl_easy_init();
...
void TelegramTypes::API::answerInlineQuery(const Json::Value& results,
...
void TelegramTypes::API::answerShippingQuery(const bool& ok,
...
void TelegramTypes::API::answerPreCheckoutQuery(const std::string& pre_checkout_query_id,
	const bool& ok,
	const std::string& error_message) const {
	std::string text;
	text = "";
...
void TelegramTypes::API::setPassportDataErrors(const Json::Value& errors,
...
Json::Value TelegramTypes::API::getGameHighScores(const __int64& user_id,
