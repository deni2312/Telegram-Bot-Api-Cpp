...
inline void from_json(const json& j, User& name){
    ...
    name.added_to_attachment_menu=j.contains("added_to_attachment_menu")?j.at("added_to_attachment_menu").get<bool>() : false ;
    name.can_join_groups=j.contains("can_join_groups")?j.at("can_join_groups").get<bool>() : false ;
    name.can_read_all_group_messages=j.contains("can_read_all_group_messages")?j.at("can_read_all_group_messages").get<bool>() : false ;
    name.supports_inline_queries=j.contains("supports_inline_queries")?j.at("supports_inline_queries").get<bool>() : false ;
}
...
inline void from_json(const json& j, Chat& name){
    ...
    name.emoji_status_custom_emoji_id=j.contains("emoji_status_custom_emoji_id")?j.at("emoji_status_custom_emoji_id").get<std::string>() : "" ;
    name.bio=j.contains("bio")?j.at("bio").get<std::string>() : "" ;
    name.has_private_forwards=j.contains("has_private_forwards")?j.at("has_private_forwards").get<bool>() : false ;
    name.has_restricted_voice_and_video_messages=j.contains("has_restricted_voice_and_video_messages")?j.at("has_restricted_voice_and_video_messages").get<bool>() : false ;
    name.join_to_send_messages=j.contains("join_to_send_messages")?j.at("join_to_send_messages").get<bool>() : false ;
    ...
    name.pinned_message=j.contains("pinned_message")?std::make_shared<Message >(j.at("pinned_message").get<Message>()) : nullptr ;
    name.permissions=j.contains("permissions")?std::make_shared<ChatPermissions >(j.at("permissions").get<ChatPermissions>()) : nullptr ;
    name.slow_mode_delay=j.contains("slow_mode_delay")?j.at("slow_mode_delay").get<int>() : 0 ;
    name.message_auto_delete_time=j.contains("message_auto_delete_time")?j.at("message_auto_delete_time").get<int>() : 0 ;
    name.has_aggressive_anti_spam_enabled=j.contains("has_aggressive_anti_spam_enabled")?j.at("has_aggressive_anti_spam_enabled").get<bool>() : false ;
    name.has_hidden_members=j.contains("has_hidden_members")?j.at("has_hidden_members").get<bool>() : false ;
    name.has_protected_content=j.contains("has_protected_content")?j.at("has_protected_content").get<bool>() : false ;
    ...
    name.location=j.contains("location")?std::make_shared<ChatLocation >(j.at("location").get<ChatLocation>()) : nullptr ;
}
...
inline void from_json(const json& j, Message& name){
    ...
    name.sender_chat=j.contains("sender_chat")?std::make_shared<Chat >(j.at("sender_chat").get<Chat>()) : nullptr ;
    name.date=j.contains("date")?j.at("date").get<int>() : 0 ;
    name.chat=j.contains("chat")?std::make_shared<Chat >(j.at("chat").get<Chat>()) : nullptr ;
    name.forward_from=j.contains("forward_from")?std::make_shared<User >(j.at("forward_from").get<User>()) : nullptr ;
    name.forward_from_chat=j.contains("forward_from_chat")?std::make_shared<Chat >(j.at("forward_from_chat").get<Chat>()) : nullptr ;
    name.forward_from_message_id=j.contains("forward_from_message_id")?j.at("forward_from_message_id").get<int>() : 0 ;
    ...
    name.is_automatic_forward=j.contains("is_automatic_forward")?j.at("is_automatic_forward").get<bool>() : false ;
    name.reply_to_message=j.contains("reply_to_message")?std::make_shared<Message >(j.at("reply_to_message").get<Message>()) : nullptr ;
    ...
    name.animation=j.contains("animation")?std::make_shared<Animation >(j.at("animation").get<Animation>()) : nullptr ;
    ...
    name.video_note=j.contains("video_note")?std::make_shared<VideoNote >(j.at("video_note").get<VideoNote>()) : nullptr ;
    ...
    name.left_chat_member=j.contains("left_chat_member")?std::make_shared<User >(j.at("left_chat_member").get<User>()) : nullptr ;
    ...
    name.supergroup_chat_created=j.contains("supergroup_chat_created")?j.at("supergroup_chat_created").get<bool>() : false ;
    name.channel_chat_created=j.contains("channel_chat_created")?j.at("channel_chat_created").get<bool>() : false ;
    name.message_auto_delete_timer_changed=j.contains("message_auto_delete_timer_changed")?std::make_shared<MessageAutoDeleteTimerChanged >(j.at("message_auto_delete_timer_changed").get<MessageAutoDeleteTimerChanged>()) : nullptr ;
    ...
    name.successful_payment=j.contains("successful_payment")?std::make_shared<SuccessfulPayment >(j.at("successful_payment").get<SuccessfulPayment>()) : nullptr ;
    name.user_shared=j.contains("user_shared")?std::make_shared<UserShared >(j.at("user_shared").get<UserShared>()) : nullptr ;
    name.chat_shared=j.contains("chat_shared")?std::make_shared<ChatShared >(j.at("chat_shared").get<ChatShared>()) : nullptr ;
    name.connected_website=j.contains("connected_website")?j.at("connected_website").get<std::string>() : "" ;
    name.write_access_allowed=j.contains("write_access_allowed")?std::make_shared<WriteAccessAllowed >(j.at("write_access_allowed").get<WriteAccessAllowed>()) : nullptr ;
    name.passport_data=j.contains("passport_data")?std::make_shared<PassportData >(j.at("passport_data").get<PassportData>()) : nullptr ;
    name.proximity_alert_triggered=j.contains("proximity_alert_triggered")?std::make_shared<ProximityAlertTriggered >(j.at("proximity_alert_triggered").get<ProximityAlertTriggered>()) : nullptr ;
    name.forum_topic_created=j.contains("forum_topic_created")?std::make_shared<ForumTopicCreated >(j.at("forum_topic_created").get<ForumTopicCreated>()) : nullptr ;
    name.forum_topic_edited=j.contains("forum_topic_edited")?std::make_shared<ForumTopicEdited >(j.at("forum_topic_edited").get<ForumTopicEdited>()) : nullptr ;
    name.forum_topic_closed=j.contains("forum_topic_closed")?std::make_shared<ForumTopicClosed >(j.at("forum_topic_closed").get<ForumTopicClosed>()) : nullptr ;
    name.forum_topic_reopened=j.contains("forum_topic_reopened")?std::make_shared<ForumTopicReopened >(j.at("forum_topic_reopened").get<ForumTopicReopened>()) : nullptr ;
    name.general_forum_topic_hidden=j.contains("general_forum_topic_hidden")?std::make_shared<GeneralForumTopicHidden >(j.at("general_forum_topic_hidden").get<GeneralForumTopicHidden>()) : nullptr ;
    name.general_forum_topic_unhidden=j.contains("general_forum_topic_unhidden")?std::make_shared<GeneralForumTopicUnhidden >(j.at("general_forum_topic_unhidden").get<GeneralForumTopicUnhidden>()) : nullptr ;
    name.video_chat_scheduled=j.contains("video_chat_scheduled")?std::make_shared<VideoChatScheduled >(j.at("video_chat_scheduled").get<VideoChatScheduled>()) : nullptr ;
    name.video_chat_started=j.contains("video_chat_started")?std::make_shared<VideoChatStarted >(j.at("video_chat_started").get<VideoChatStarted>()) : nullptr ;
    name.video_chat_ended=j.contains("video_chat_ended")?std::make_shared<VideoChatEnded >(j.at("video_chat_ended").get<VideoChatEnded>()) : nullptr ;
    name.video_chat_participants_invited=j.contains("video_chat_participants_invited")?std::make_shared<VideoChatParticipantsInvited >(j.at("video_chat_participants_invited").get<VideoChatParticipantsInvited>()) : nullptr ;
    name.web_app_data=j.contains("web_app_data")?std::make_shared<WebAppData >(j.at("web_app_data").get<WebAppData>()) : nullptr ;
    name.reply_markup=j.contains("reply_markup")?std::make_shared<InlineKeyboardMarkup >(j.at("reply_markup").get<InlineKeyboardMarkup>()) : nullptr ;
}
...
inline void from_json(const json& j, Poll& name){
    ...
    name.type=j.contains("type")?j.at("type").get<std::string>() : "" ;
    name.allows_multiple_answers=j.contains("allows_multiple_answers")?j.at("allows_multiple_answers").get<bool>() : false ;
...
inline void from_json(const json& j, Location& name){
    ...
    name.proximity_alert_radius=j.contains("proximity_alert_radius")?j.at("proximity_alert_radius").get<int>() : 0 ;
}
...
inline void from_json(const json& j, ReplyKeyboardMarkup& name){
    ...
    name.input_field_placeholder=j.contains("input_field_placeholder")?j.at("input_field_placeholder").get<std::string>() : "" ;
...
inline void from_json(const json& j, KeyboardButton& name){
    name.text=j.contains("text")?j.at("text").get<std::string>() : "" ;
    name.request_user=j.contains("request_user")?std::make_shared<KeyboardButtonRequestUser >(j.at("request_user").get<KeyboardButtonRequestUser>()) : nullptr ;
    name.request_chat=j.contains("request_chat")?std::make_shared<KeyboardButtonRequestChat >(j.at("request_chat").get<KeyboardButtonRequestChat>()) : nullptr ;
    ...
    name.request_poll=j.contains("request_poll")?std::make_shared<KeyboardButtonPollType >(j.at("request_poll").get<KeyboardButtonPollType>()) : nullptr ;
    name.web_app=j.contains("web_app")?std::make_shared<WebAppInfo >(j.at("web_app").get<WebAppInfo>()) : nullptr ;
}
...
inline void from_json(const json& j, KeyboardButtonRequestChat& name){
    ...
    name.user_administrator_rights=j.contains("user_administrator_rights")?std::make_shared<ChatAdministratorRights >(j.at("user_administrator_rights").get<ChatAdministratorRights>()) : nullptr ;
    name.bot_administrator_rights=j.contains("bot_administrator_rights")?std::make_shared<ChatAdministratorRights >(j.at("bot_administrator_rights").get<ChatAdministratorRights>()) : nullptr ;
...
inline void from_json(const json& j, InlineKeyboardButton& name){
    ...
    name.web_app=j.contains("web_app")?std::make_shared<WebAppInfo >(j.at("web_app").get<WebAppInfo>()) : nullptr ;
    name.login_url=j.contains("login_url")?std::make_shared<LoginUrl >(j.at("login_url").get<LoginUrl>()) : nullptr ;
    name.switch_inline_query=j.contains("switch_inline_query")?j.at("switch_inline_query").get<std::string>() : "" ;
    name.switch_inline_query_current_chat=j.contains("switch_inline_query_current_chat")?j.at("switch_inline_query_current_chat").get<std::string>() : "" ;
    name.callback_game=j.contains("callback_game")?std::make_shared<CallbackGame >(j.at("callback_game").get<CallbackGame>()) : nullptr ;
...
inline void from_json(const json& j, LoginUrl& name){
    ...
    name.request_write_access=j.contains("request_write_access")?j.at("request_write_access").get<bool>() : false ;
}
...
inline void from_json(const json& j, ChatInviteLink& name){
    ...
    name.creates_join_request=j.contains("creates_join_request")?j.at("creates_join_request").get<bool>() : false ;
    ...
    name.pending_join_request_count=j.contains("pending_join_request_count")?j.at("pending_join_request_count").get<int>() : 0 ;
}
...
inline void from_json(const json& j, ChatAdministratorRights& name){
    ...
    name.can_manage_video_chats=j.contains("can_manage_video_chats")?j.at("can_manage_video_chats").get<bool>() : false ;
    name.can_restrict_members=j.contains("can_restrict_members")?j.at("can_restrict_members").get<bool>() : false ;
...
inline void from_json(const json& j, ChatMemberRestricted& name){
    ...
    name.can_send_video_notes=j.contains("can_send_video_notes")?j.at("can_send_video_notes").get<bool>() : false ;
    name.can_send_voice_notes=j.contains("can_send_voice_notes")?j.at("can_send_voice_notes").get<bool>() : false ;
    name.can_send_polls=j.contains("can_send_polls")?j.at("can_send_polls").get<bool>() : false ;
    name.can_send_other_messages=j.contains("can_send_other_messages")?j.at("can_send_other_messages").get<bool>() : false ;
    name.can_add_web_page_previews=j.contains("can_add_web_page_previews")?j.at("can_add_web_page_previews").get<bool>() : false ;
    name.can_change_info=j.contains("can_change_info")?j.at("can_change_info").get<bool>() : false ;
    name.can_invite_users=j.contains("can_invite_users")?j.at("can_invite_users").get<bool>() : false ;
    name.can_pin_messages=j.contains("can_pin_messages")?j.at("can_pin_messages").get<bool>() : false ;
    name.can_manage_topics=j.contains("can_manage_topics")?j.at("can_manage_topics").get<bool>() : false ;
...
inline void from_json(const json& j, ChatMemberUpdated& name){
    ...
    name.from=j.contains("from")?std::make_shared<User >(j.at("from").get<User>()) : nullptr ;
    name.date=j.contains("date")?j.at("date").get<int>() : 0 ;
    name.old_chat_member=j.contains("old_chat_member")?std::make_shared<ChatMember >(j.at("old_chat_member").get<ChatMember>()) : nullptr ;
    name.new_chat_member=j.contains("new_chat_member")?std::make_shared<ChatMember >(j.at("new_chat_member").get<ChatMember>()) : nullptr ;
    name.invite_link=j.contains("invite_link")?std::make_shared<ChatInviteLink >(j.at("invite_link").get<ChatInviteLink>()) : nullptr ;
}
...
inline void from_json(const json& j, InputMediaDocument& name){
    ...
    name.caption_entities=caption_entities;
    name.disable_content_type_detection=j.contains("disable_content_type_detection")?j.at("disable_content_type_detection").get<bool>() : false ;
}
...
inline void from_json(const json& j, InputFile& name){
    ...
    name.entities=entities;
    name.disable_web_page_preview=j.contains("disable_web_page_preview")?j.at("disable_web_page_preview").get<bool>() : false ;
    name.disable_notification=j.contains("disable_notification")?j.at("disable_notification").get<bool>() : false ;
    ...
    name.allow_sending_without_reply=j.contains("allow_sending_without_reply")?j.at("allow_sending_without_reply").get<bool>() : false ;
    name.reply_markup=j.contains("reply_markup")?std::make_shared<InlineKeyboardMarkup >(j.at("reply_markup").get<InlineKeyboardMarkup>()) : nullptr ;
}
...
inline void from_json(const json& j, Sticker& name){
    ...
    name.premium_animation=j.contains("premium_animation")?std::make_shared<File >(j.at("premium_animation").get<File>()) : nullptr ;
    name.mask_position=j.contains("mask_position")?std::make_shared<MaskPosition >(j.at("mask_position").get<MaskPosition>()) : nullptr ;
    name.custom_emoji_id=j.contains("custom_emoji_id")?j.at("custom_emoji_id").get<std::string>() : "" ;
    name.file_size=j.contains("file_size")?j.at("file_size").get<int>() : 0 ;
}
...
inline void from_json(const json& j, InlineQueryResult& name){
    ...
    name.id=j.contains("id")?j.at("id").get<std::string>() : "" ;
    name.title=j.contains("title")?j.at("title").get<std::string>() : "" ;
    name.input_message_content=j.contains("input_message_content")?std::make_shared<InputMessageContent >(j.at("input_message_content").get<InputMessageContent>()) : nullptr ;
    name.reply_markup=j.contains("reply_markup")?std::make_shared<InlineKeyboardMarkup >(j.at("reply_markup").get<InlineKeyboardMarkup>()) : nullptr ;
    name.url=j.contains("url")?j.at("url").get<std::string>() : "" ;
...
inline void from_json(const json& j, InputInvoiceMessageContent& name){
    ...
    name.need_shipping_address=j.contains("need_shipping_address")?j.at("need_shipping_address").get<bool>() : false ;
    name.send_phone_number_to_provider=j.contains("send_phone_number_to_provider")?j.at("send_phone_number_to_provider").get<bool>() : false ;
    name.send_email_to_provider=j.contains("send_email_to_provider")?j.at("send_email_to_provider").get<bool>() : false ;
...
inline void from_json(const json& j, OrderInfo& name){
    ...
    name.shipping_address=j.contains("shipping_address")?std::make_shared<ShippingAddress >(j.at("shipping_address").get<ShippingAddress>()) : nullptr ;
}
...
inline void from_json(const json& j, SuccessfulPayment& name){
    ...
    name.order_info=j.contains("order_info")?std::make_shared<OrderInfo >(j.at("order_info").get<OrderInfo>()) : nullptr ;
    name.telegram_payment_charge_id=j.contains("telegram_payment_charge_id")?j.at("telegram_payment_charge_id").get<std::string>() : "" ;
    name.provider_payment_charge_id=j.contains("provider_payment_charge_id")?j.at("provider_payment_charge_id").get<std::string>() : "" ;
}
...
inline void from_json(const json& j, PassportData& name){
    ...
    name.data=data;
    name.credentials=j.contains("credentials")?std::make_shared<EncryptedCredentials >(j.at("credentials").get<EncryptedCredentials>()) : nullptr ;
}
...
inline void from_json(const json& j, EncryptedPassportElement& name){
    ...
    name.files=files;
    name.front_side=j.contains("front_side")?std::make_shared<PassportFile >(j.at("front_side").get<PassportFile>()) : nullptr ;
    name.reverse_side=j.contains("reverse_side")?std::make_shared<PassportFile >(j.at("reverse_side").get<PassportFile>()) : nullptr ;
