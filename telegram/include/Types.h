...
inline void from_json(const json &j, WebhookInfo &name) {
    ...
    name.has_custom_certificate = j.contains("has_custom_certificate") ? j.at("has_custom_certificate").get<bool>()
                                                                       : false;
    ...
    name.last_synchronization_error_date = j.contains("last_synchronization_error_date") ? j.at(
            "last_synchronization_error_date").get<int>() : 0;
...
inline void from_json(const json &j, Message &name) {
    ...
    name.forward_from_message_id = j.contains("forward_from_message_id") ? j.at("forward_from_message_id").get<int>()
                                                                         : 0;
...
inline void to_json(json &j, const Message &name) {
    ...
    if (name.message_auto_delete_timer_changed) {
    ...
    if (name.general_forum_topic_unhidden) {
    ...
    if (name.video_chat_participants_invited) {
